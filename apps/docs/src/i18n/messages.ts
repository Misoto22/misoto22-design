...
const en = {
  ...
  agents: {
    ...
    installed: 'The package documents itself, out of the version sitting in node_modules rather than whatever this site published last — which is the copy that is right when the two disagree. One component runs about 500 tokens against 28,000 for all fifty-two.',
...
const zh: Messages = {
  ...
  agents: {
    ...
    installed: '包会自己描述自己，依据的是 node_modules 里那个版本，而不是这个站点最后一次发布的内容——两者不一致时，那份才是对的。单个组件约 500 token，全部五十二个是 28,000。',
